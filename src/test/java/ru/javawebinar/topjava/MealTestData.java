...
public class MealTestData {
    ...
    public static final int MEAL_NOT_FOUND = MEAL_ID + 8;
    ...
    public static final Meal adminMeal = new Meal(ADMIN_MEAL_ID, LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Ланч", 500);
